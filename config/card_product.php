...
<!-- <script>
    $(document).ready(function() {
        $('.add-to-cart').on('click', function(e) {
            ...
            $.ajax({
                url: 'config/add_to_cart.php', // Fichier PHP pour gérer l'ajout au panier
                method: 'POST',
                data: { id: productId },
        ...
        function updateCartIcon(count) {
            $('.cart-icon .cart-count').text(count);
        }

        // Envoyer une requête pour réinitialiser l'heure de la dernière activité toutes les 5 minutes
...
<!-- <script>
    $(document).ready(function() {
        ...
        function envoyerCommande() {
            ...
            // Vider le localStorage après l'envoi de la commande
