    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link font-weight-bolder active" href="index.html">Accueil</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link font-weight-bolder" href="produits.php">Produits</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link font-weight-bolder" href="services.php">Services</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link font-weight-bolder" href="about_us.php">À Propos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link font-weight-bolder" href="contact_us.php">Contact</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link font-weight-bolder" href="realisation.php">Contact</a>
                </li>
            </ul>
        </div>
    </div>
